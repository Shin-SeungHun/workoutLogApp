...
public class MyPageActivity_ extends AppCompatActivity {
    ...
    TextView tvState;
    int age;
    float height=0, weight=0, bodyFat=0, bench=0, dead=0, squat=0;

    String gender;
    EditText etAge, etHeight, etWeight, etBodyFat, etBench, etDead, etSquat;
...
// 1. Shared Preference 초기화
        ...
        etDead = findViewById(R.id.etDead);
        etSquat = findViewById(R.id.etSquat);
        tvState = findViewById(R.id.tvSate);
        ...
        if (selectedId == R.id.male_radio_button) {
            ...
            btnSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    editor.commit(); // 저장
                    Toast.makeText(MyPageActivity_.this, "저장되었습니다.", Toast.LENGTH_SHORT).show();
...
return;
            ...
            btnCancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent main = new Intent(MyPageActivity_.this, MainActivity.class);
                    startActivity(main);
